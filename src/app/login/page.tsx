import { LoginForm } from '@/auth/login/components/form/form'
      ...
      <div className="max-w-lg w-full space-y-8 bg-white p-16 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border-r-4">
        <div>
          ...
          <p className="mt-3 text-center text-sm text-gray-600">
            ...
            <Link href="/signup" className="font-semibold text-indigo-600 hover:text-indigo-500 transition-colors duration-300">
              Sign up for free
            </Link>
          </p>
        </div>
